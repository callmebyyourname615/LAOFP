...
check "B2 Performance k6 results"       "performance/results/*.json"
...
check "B8 Static verifier logs"         "scripts/evidence/*"

echo
echo "Next steps to collect missing evidence:"
echo "  B1: ./mvnw verify"
echo "  B2: performance/scripts/run-k6.sh smoke && ... sustained2k && ... burst10k && ... soak8h"
