...
Generated: 2026-08-03T02:50:33Z
...
- Methods: `DELETE` 6, `GET` 122, `PATCH` 6, `POST` 112, `PUT` 4
- Risk: `high` 50, `read` 122, `standard` 78
- Domains: 36
- Verified on UAT: 200/250
...
| [ ] | GET | `/api/admin/security-events` | read | authenticated read + unauthorized negative | - |
...
| Done | Method | Path | Risk | Required Evidence | Evidence |
| --- | --- | --- | --- | --- | --- |
| [ ] | GET | `/api/fees/decisions` | read | authenticated read + unauthorized negative | - |
| [ ] | GET | `/api/fees/exceptions` | read | authenticated read + unauthorized negative | - |
...
| Done | Method | Path | Risk | Required Evidence | Evidence |
| --- | --- | --- | --- | --- | --- |
| [ ] | GET | `/api/risk/rules` | read | authenticated read + unauthorized negative | - |
| [ ] | POST | `/api/risk/rules/{id}/enable` | standard | happy path + authorization + validation + cleanup | - |
| [ ] | POST | `/api/risk/rules/{id}/disable` | standard | happy path + authorization + validation + cleanup | - |
| [ ] | GET | `/api/risk/scores/distribution` | read | authenticated read + unauthorized negative | - |
...
| Done | Method | Path | Risk | Required Evidence | Evidence |
| --- | --- | --- | --- | --- | --- |
| [ ] | GET | `/v1/aml/reports` | read | authenticated read + unauthorized negative | - |
...
| [ ] | GET | `/v1/operator/report-delivery-history` | read | authenticated read + unauthorized negative | - |
