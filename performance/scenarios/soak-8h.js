...
export const options = { scenarios: { soak: { executor: 'constant-arrival-rate', rate: Number(__ENV.TARGET_TPS || 5000), timeUnit: '1s', duration: __ENV.DURATION || '8h', preAllocatedVUs: Number(__ENV.PREALLOCATED_VUS || 300), maxVUs: Number(__ENV.MAX_VUS || 2000), gracefulStop: '1m' } }, thresholds: { ...commonThresholds, dropped_iterations: ['count==0'], http_req_duration: ['p(95)<750', 'p(99)<1500'] } };
