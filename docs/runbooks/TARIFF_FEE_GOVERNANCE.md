# Tariff and Fee Governance Runbook

## Purpose
Versioned four-eyes tariff plans, deterministic fee calculations, immutable assessments, and bundle validation.

## Detection
Use the Phase 35 database evidence tables, Prometheus alerts, and control CronJob logs. Every operator action must include a ticket or incident reference.
