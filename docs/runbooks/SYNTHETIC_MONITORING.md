# Synthetic Transaction Monitoring Runbook

## Purpose
Reserved synthetic participants, signed probes, bounded responses, cleanup status, and failure alerting.

## Detection
Use the Phase 41 database evidence tables, Prometheus alerts, and control CronJob logs. Every operator action must include a ticket or incident reference.
