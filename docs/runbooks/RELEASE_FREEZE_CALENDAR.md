...
## Detection
Use the Phase 40 database evidence tables, Prometheus alerts, and control CronJob logs. Every operator action must include a ticket or incident reference.
