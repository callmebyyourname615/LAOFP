...
## Switching Manual Adjustments Pending
...
- Summary: Manual financial adjustment remains pending
- Description: A four-eyes manual financial adjustment remains unresolved for four hours.

PromQL/expression:

```promql
switching_adjustments_pending > 0
```

Immediate response:

1. Confirm `SwitchingManualAdjustmentsPending` is active in Prometheus and Alertmanager, including labels and receiver.
