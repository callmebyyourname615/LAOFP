# FX Rate Governance Runbook

## Purpose
Fresh multi-provider quorum, median publication, deviation limits, four-eyes approval, and fail-closed staleness checks.

## Detection
Use the Phase 36 database evidence tables, Prometheus alerts, and control CronJob logs. Every operator action must include a ticket or incident reference.
