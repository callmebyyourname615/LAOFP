# Intraday Liquidity and Prefunding Runbook

## Purpose
Atomic reservations, minimum operating balances, expiry, settlement, breach evidence, and five-minute controls.

## Detection
Use the Phase 34 database evidence tables, Prometheus alerts, and control CronJob logs. Every operator action must include a ticket or incident reference.
