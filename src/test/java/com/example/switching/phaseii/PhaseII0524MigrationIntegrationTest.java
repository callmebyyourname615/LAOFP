...
class PhaseII0524MigrationIntegrationTest extends AbstractIntegrationTest {
    ...
    @Test void migrationsReachV90AndCreateAllPhaseIIModules(){
        Integer v90=jdbc.queryForObject("SELECT count(*) FROM flyway_schema_history WHERE version='90' AND success",Integer.class);
        assertEquals(1,v90);
